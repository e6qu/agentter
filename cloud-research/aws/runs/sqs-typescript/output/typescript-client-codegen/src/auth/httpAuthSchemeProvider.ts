 ...
 * @internal
 */
export const defaultSQSHttpAuthSchemeParametersProvider = async (config: SQSClientResolvedConfig, context: HandlerExecutionContext, input: object): Promise<SQSHttpAuthSchemeParameters> => {
  return {
