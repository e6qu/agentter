...
> {
  ...
  constructor(...[configuration]: __CheckOptionalClientConfig<SQSClientConfig>) {
    ...
    let _config_7 = resolveQueueUrlConfig(_config_6);
    ...
    this.middlewareStack.use(getHttpAuthSchemeEndpointRuleSetPlugin(this.config
      , {
        httpAuthSchemeParametersProvider: defaultSQSHttpAuthSchemeParametersProvider,identityProviderConfigProvider: async (config: SQSClientResolvedConfig) => new DefaultIdentityProviderConfig({
