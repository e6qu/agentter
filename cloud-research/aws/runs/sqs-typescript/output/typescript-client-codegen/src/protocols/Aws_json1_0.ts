...
const de_CommandError = async(
   ...
   */
  const de_BatchRequestTooLongRes = async (
    parsedOutput: any,
    context: __SerdeContext
   ...
   */
  const de_EmptyBatchRequestRes = async (
    parsedOutput: any,
    context: __SerdeContext
   ...
   */
  const de_InvalidAddressRes = async (
    parsedOutput: any,
    context: __SerdeContext
  ): Promise<InvalidAddress> => {
    const body = parsedOutput.body
    const deserialized: any = _json(body);
   ...
   */
  const de_InvalidBatchEntryIdRes = async (
    parsedOutput: any,
    context: __SerdeContext
   ...
   */
  const de_InvalidIdFormatRes = async (
    parsedOutput: any,
    context: __SerdeContext
   ...
   */
  const de_InvalidSecurityRes = async (
    parsedOutput: any,
    context: __SerdeContext
  ): Promise<InvalidSecurity> => {
    const body = parsedOutput.body
    const deserialized: any = _json(body);
   ...
   */
  const de_KmsAccessDeniedRes = async (
    parsedOutput: any,
    context: __SerdeContext
  ): Promise<KmsAccessDenied> => {
    const body = parsedOutput.body
    const deserialized: any = _json(body);
   ...
   */
  const de_KmsInvalidKeyUsageRes = async (
    parsedOutput: any,
    context: __SerdeContext
  ): Promise<KmsInvalidKeyUsage> => {
    const body = parsedOutput.body
    const deserialized: any = _json(body);
   ...
   */
  const de_KmsInvalidStateRes = async (
    parsedOutput: any,
    context: __SerdeContext
  ): Promise<KmsInvalidState> => {
    const body = parsedOutput.body
    const deserialized: any = _json(body);
   ...
   */
  const de_KmsOptInRequiredRes = async (
    parsedOutput: any,
    context: __SerdeContext
   ...
   */
  const de_KmsThrottledRes = async (
    parsedOutput: any,
    context: __SerdeContext
  ): Promise<KmsThrottled> => {
    const body = parsedOutput.body
    const deserialized: any = _json(body);
   ...
   */
  const de_MessageNotInflightRes = async (
    parsedOutput: any,
    context: __SerdeContext
   ...
   */
  const de_QueueDoesNotExistRes = async (
    parsedOutput: any,
    context: __SerdeContext
   ...
   */
  const de_QueueNameExistsRes = async (
    parsedOutput: any,
    context: __SerdeContext
   ...
   */
  const de_RequestThrottledRes = async (
    parsedOutput: any,
    context: __SerdeContext
  ): Promise<RequestThrottled> => {
    const body = parsedOutput.body
    const deserialized: any = _json(body);
   ...
   */
  const se_AttributeNameList = (
    input: (QueueAttributeName)[],
    context: __SerdeContext
  ): any => {
    return input.filter((e: any) => e != null).map(entry => {
      return _toStr(entry);
   ...
   */
  const se_CancelMessageMoveTaskRequest = (
   ...
   */
  const se_DeleteMessageBatchRequestEntry = (
   ...
   */
  const se_GetQueueAttributesRequest = (
   ...
   */
  const se_ListMessageMoveTasksRequest = (
   ...
   */
  const se_MessageAttributeValue = (
   ...
   */
  const se_MessageBodyAttributeMap = (
  ...
  const se_MessageBodySystemAttributeMap = (
    ...
    return Object.entries(input).reduce((acc: Record<string, any>, [key, value]: [MessageSystemAttributeNameForSends| string, any]) => {
      if (value === null) {
        return acc;
      }
   ...
   */
  const se_MessageSystemAttributeList = (
   ...
   */
  const se_MessageSystemAttributeValue = (
   ...
   */
  const se_QueueAttributeMap = (
    input: Partial<Record<QueueAttributeName, string>>,
    context: __SerdeContext
  ): any => {
   ...
   */
  const se_ReceiveMessageRequest = (
   ...
   */
  const se_RemovePermissionRequest = (
   ...
   */
  const se_SendMessageBatchRequest = (
   ...
   */
  const se_SendMessageBatchRequestEntry = (
   ...
   */
  const se_SendMessageBatchRequestEntryList = (
    input: (SendMessageBatchRequestEntry)[],
    context: __SerdeContext
  ): any => {
    return input.filter((e: any) => e != null).map(entry => {
   ...
   */
  const se_SetQueueAttributesRequest = (
   ...
   */
  const se_StartMessageMoveTaskRequest = (
   ...
   */
  const de_MessageAttributeValue = (
    output: any,
    context: __SerdeContext
  ): MessageAttributeValue => {
    return take(output, {
