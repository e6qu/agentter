 ...
 * @public
 */
export class TagQueueCommand extends $Command.classBuilder<TagQueueCommandInput, TagQueueCommandOutput, SQSClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>()
  .ep(commonParams)
