 ...
 * @public
 */
export class GetQueueAttributesCommand extends $Command.classBuilder<GetQueueAttributesCommandInput, GetQueueAttributesCommandOutput, SQSClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>()
  .ep(commonParams)
