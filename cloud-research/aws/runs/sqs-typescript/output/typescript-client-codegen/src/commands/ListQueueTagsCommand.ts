 ...
 * @public
 */
export class ListQueueTagsCommand extends $Command.classBuilder<ListQueueTagsCommandInput, ListQueueTagsCommandOutput, SQSClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>()
  .ep(commonParams)
