 ...
 * @public
 */
export class ListDeadLetterSourceQueuesCommand extends $Command.classBuilder<ListDeadLetterSourceQueuesCommandInput, ListDeadLetterSourceQueuesCommandOutput, SQSClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>()
  .ep(commonParams)
