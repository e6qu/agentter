 ...
 * @public
 */
export class ListMessageMoveTasksCommand extends $Command.classBuilder<ListMessageMoveTasksCommandInput, ListMessageMoveTasksCommandOutput, SQSClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>()
  .ep(commonParams)
