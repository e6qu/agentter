 ...
 * @public
 */
export class AddPermissionCommand extends $Command.classBuilder<AddPermissionCommandInput, AddPermissionCommandOutput, SQSClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>()
  .ep(commonParams)
