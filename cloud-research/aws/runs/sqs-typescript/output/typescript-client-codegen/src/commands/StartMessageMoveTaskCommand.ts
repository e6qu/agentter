 ...
 * @public
 */
export class StartMessageMoveTaskCommand extends $Command.classBuilder<StartMessageMoveTaskCommandInput, StartMessageMoveTaskCommandOutput, SQSClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>()
  .ep(commonParams)
