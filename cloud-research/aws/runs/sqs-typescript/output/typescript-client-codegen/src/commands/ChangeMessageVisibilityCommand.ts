 ...
 * @public
 */
export class ChangeMessageVisibilityCommand extends $Command.classBuilder<ChangeMessageVisibilityCommandInput, ChangeMessageVisibilityCommandOutput, SQSClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>()
  .ep(commonParams)
