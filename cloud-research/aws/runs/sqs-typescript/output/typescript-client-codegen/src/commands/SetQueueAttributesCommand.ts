 ...
 * @public
 */
export class SetQueueAttributesCommand extends $Command.classBuilder<SetQueueAttributesCommandInput, SetQueueAttributesCommandOutput, SQSClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>()
  .ep(commonParams)
