 ...
 * @public
 */
export class UntagQueueCommand extends $Command.classBuilder<UntagQueueCommandInput, UntagQueueCommandOutput, SQSClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>()
  .ep(commonParams)
