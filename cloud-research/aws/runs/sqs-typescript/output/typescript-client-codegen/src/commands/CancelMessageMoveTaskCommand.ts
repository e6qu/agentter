 ...
 * @public
 */
export class CancelMessageMoveTaskCommand extends $Command.classBuilder<CancelMessageMoveTaskCommandInput, CancelMessageMoveTaskCommandOutput, SQSClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>()
  .ep(commonParams)
