 ...
 * @public
 */
export class DeleteMessageBatchCommand extends $Command.classBuilder<DeleteMessageBatchCommandInput, DeleteMessageBatchCommandOutput, SQSClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>()
  .ep(commonParams)
