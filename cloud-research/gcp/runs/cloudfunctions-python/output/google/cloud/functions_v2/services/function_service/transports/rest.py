...
class FunctionServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    def post_get_function_with_metadata(self, response: functions.Function, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[functions.Function, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for get_function
    ...
    def pre_list_runtimes(self, request: functions.ListRuntimesRequest, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[functions.ListRuntimesRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
    ...
    def post_list_runtimes_with_metadata(self, response: functions.ListRuntimesResponse, metadata: Sequence[Tuple[str, Union[str, bytes]]]) -> Tuple[functions.ListRuntimesResponse, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for list_runtimes
...
class FunctionServiceRestTransport(_BaseFunctionServiceRestTransport):
    ...
    class _CreateFunction(_BaseFunctionServiceRestTransport._BaseCreateFunction, FunctionServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = FunctionServiceRestTransport._CreateFunction._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _DeleteFunction(_BaseFunctionServiceRestTransport._BaseDeleteFunction, FunctionServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = FunctionServiceRestTransport._DeleteFunction._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _GenerateDownloadUrl(_BaseFunctionServiceRestTransport._BaseGenerateDownloadUrl, FunctionServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = FunctionServiceRestTransport._GenerateDownloadUrl._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _GenerateUploadUrl(_BaseFunctionServiceRestTransport._BaseGenerateUploadUrl, FunctionServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = FunctionServiceRestTransport._GenerateUploadUrl._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _GetFunction(_BaseFunctionServiceRestTransport._BaseGetFunction, FunctionServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = FunctionServiceRestTransport._GetFunction._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _ListFunctions(_BaseFunctionServiceRestTransport._BaseListFunctions, FunctionServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = FunctionServiceRestTransport._ListFunctions._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _ListRuntimes(_BaseFunctionServiceRestTransport._BaseListRuntimes, FunctionServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = FunctionServiceRestTransport._ListRuntimes._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _UpdateFunction(_BaseFunctionServiceRestTransport._BaseUpdateFunction, FunctionServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = FunctionServiceRestTransport._UpdateFunction._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _ListLocations(_BaseFunctionServiceRestTransport._BaseListLocations, FunctionServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = FunctionServiceRestTransport._ListLocations._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _GetIamPolicy(_BaseFunctionServiceRestTransport._BaseGetIamPolicy, FunctionServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = FunctionServiceRestTransport._GetIamPolicy._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _SetIamPolicy(_BaseFunctionServiceRestTransport._BaseSetIamPolicy, FunctionServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = FunctionServiceRestTransport._SetIamPolicy._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _TestIamPermissions(_BaseFunctionServiceRestTransport._BaseTestIamPermissions, FunctionServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = FunctionServiceRestTransport._TestIamPermissions._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request, body)
    ...
    class _GetOperation(_BaseFunctionServiceRestTransport._BaseGetOperation, FunctionServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = FunctionServiceRestTransport._GetOperation._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
    ...
    class _ListOperations(_BaseFunctionServiceRestTransport._BaseListOperations, FunctionServiceRestStub):
        ...
        def __call__(self,
            ...
            # Send the request
            response = FunctionServiceRestTransport._ListOperations._get_response(self._host, metadata, query_params, self._session, timeout, transcoded_request)
