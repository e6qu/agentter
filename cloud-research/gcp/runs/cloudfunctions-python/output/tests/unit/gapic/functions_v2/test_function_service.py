...
def test__get_default_mtls_endpoint():
    ...
    assert FunctionServiceClient._get_default_mtls_endpoint(custom_endpoint) == custom_endpoint
...
async def test_generate_download_url_async(request_type, transport: str = 'grpc_asyncio'):
    client = FunctionServiceAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
